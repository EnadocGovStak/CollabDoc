...
Status: In progress, backend/API, generation-form, Field Library UI, template editor analysis, direct insertion controls, unmanaged-field migration review, save-readiness notes, and save-time field enrichment implemented.
...
- Deeper validation enforcement and richer field validation rules for promoted placeholders.
