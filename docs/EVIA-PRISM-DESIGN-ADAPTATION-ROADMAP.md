...
- Generate from Template is now guided, and Template Editor has a first guided creation banner/checklist around the existing editor. Richer unknown-placeholder migration actions and deeper authoring validation still need work.
...
Status: Started; Generate from Template first pass completed May 21, 2026.
